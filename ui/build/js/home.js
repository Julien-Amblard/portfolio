...
var home = function () {
	...
	var color = ', 100%, 70%'; //couleur
	var colorH = rand(190, 210); //saturation hsla
	var centerVariable = 5;
	var aParticlesType = [[r * .4, r * .401], [r * .4, r * .401], [r * .45, r * .47], [r * .401, r * .48], [r * .401, r * .48], [r * .48, r * .59]];
	var relativeDist = r * .59 - r * .4;
	...
	var props = function props() {
		...
		var y = cY + (dist - 300) * Math.sin(ro); ///calculuer position autour d'un cercle : y = centerY + ( rayon * Math.sin( angle ) );
